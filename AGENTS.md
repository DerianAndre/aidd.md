...
**`content/routing.md`** is the canonical source for agent hierarchy, task dispatch, and workflow routing. This file (`AGENTS.md`) is the operational protocol — startup, session lifecycle, memory operations, session end.

If there is conflict: `content/routing.md` wins for agent roles and dispatch; this file wins for operational protocol.
