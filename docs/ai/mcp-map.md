...
- **memory**: aidd_memory_search, aidd_memory_context, aidd_memory_get, aidd_memory_add_decision, aidd_memory_add_mistake, aidd_memory_add_convention, aidd_memory_prune, aidd_memory_export
