...
|---|------|-----------|------|
| P1 | Implement McpMemoryAdapter (JSON-RPC client) | High | 1 |
| P2 | Database schema verification before queries | Medium | 2 |
| P3 | Error state UI in MemoryPanel | Low | 3 |
| P4 | Integration tests | Medium | 2 |
