      ...
      <div className="flex items-center gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-border bg-muted/50 py-1.5 pl-9 pr-3 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:border-primary"
          />
        </div>
        <button
          type="button"
      ...
      {filtered.map((group) => {
        ...
        return (
          <div key={group.name} className="rounded-lg border border-border overflow-hidden">
            ...
            <button
              type="button"
              className="flex w-full items-center gap-2 bg-muted px-4 py-2.5 text-left transition-colors hover:bg-accent"
