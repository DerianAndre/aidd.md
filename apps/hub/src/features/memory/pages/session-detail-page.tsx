    ...
    () => [
      {
        type: "separator",
        key: "sep-session",
        label: t("page.sessionDetail.metadata"),
      },
      {
        type: "readonly",
        key: "sessionId",
        label: t("page.sessionDetail.sessionId"),
      },
      {
        type: "text",
        key: "sessionName",
        label: t("page.sessionDetail.sessionName"),
        placeholder: t("page.sessionDetail.sessionNamePlaceholder"),
      },
      {
        type: "text",
        key: "sessionInput",
        label: t("page.sessionDetail.input"),
      },
      { type: "text", key: "branch", label: t("page.sessionDetail.branch") },
      {
        type: "readonly",
        key: "_status",
        label: t("page.sessionDetail.status"),
      },
      {
        type: "datetime",
        key: "startedAt",
        label: t("page.sessionDetail.startedAt"),
      },
      {
        type: "datetime",
        key: "endedAt",
        label: t("page.sessionDetail.endedAt"),
      },
      {
        type: "separator",
        key: "sep-provider",
        label: t("page.sessionDetail.provider"),
      },
      {
        type: "text",
        key: "provider",
      ...
      },
      {
        type: "text",
        key: "client",
        label: t("page.sessionDetail.client"),
        placeholder: "e.g. claude-code",
      },
      {
        type: "separator",
        key: "sep-classification",
        label: t("page.sessionDetail.classification"),
      },
      {
        type: "select",
        key: "taskDomain",
        label: t("page.sessionDetail.domain"),
        options: DOMAIN_OPTIONS,
      },
      {
        type: "select",
        key: "taskNature",
        label: t("page.sessionDetail.nature"),
        options: NATURE_OPTIONS,
      },
      {
        type: "select",
        key: "taskComplexity",
        label: t("page.sessionDetail.complexity"),
    ...
    () => [
      {
        type: "switch",
        key: "testsPassing",
        label: t("page.sessionDetail.testsPassing").replace("Tests: ", ""),
      },
      {
        type: "number",
        key: "complianceScore",
    ...
    <div>
      ...
      <div className="space-y-6">
          ...
          >
            <EditableStructuredList
              ...
              fields={[
                {
                  key: "decision",
                  label: t("page.sessionDetail.decisionLabel"),
                  placeholder: t("page.sessionDetail.decisionPlaceholder"),
                },
                {
                  key: "reasoning",
                  label: t("page.sessionDetail.reasoningLabel"),
                  placeholder: t("page.sessionDetail.reasoningPlaceholder"),
                  multiline: true,
                },
              ]}
            />
          ...
          >
            <EditableStructuredList
              ...
              fields={[
                {
                  key: "error",
                  label: t("page.sessionDetail.errorLabel"),
                  placeholder: t("page.sessionDetail.errorPlaceholder"),
                },
                {
                  key: "fix",
                  label: t("page.sessionDetail.fixLabel"),
                  placeholder: t("page.sessionDetail.fixPlaceholder"),
                  multiline: true,
                },
              ]}
            />
        ...
        >
          {artifacts.length === 0 ? (
            <p className="text-xs text-muted-foreground italic">
              No artifacts generated for this session
            </p>
          ) : (
...
function OutcomeStat({
  ...
  return (
    <div className="space-y-0.5">
      ...
      <p className={`text-sm font-semibold capitalize ${colorClasses[color]}`}>
        {value}
      </p>
    </div>
  );
