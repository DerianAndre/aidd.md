...
export function createEngineServer(projectPath?: string) {
  return createAiddServer({
    name: 'aidd-engine',
    version: PKG_VERSION,
    instructions: 'Complete AIDD AI-Driven Development framework: guidance + memory + validation. 63 tools for project detection, task routing, knowledge base, sessions, memory search, evolution, analytics, code validation, enforcement, and CI. Use aidd_start for one-call setup.',
